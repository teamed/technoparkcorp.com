...
class theActivity
{
    ...
    public function __get($name)
    {
        ...
        FaZend_Exception::raise(
            'Activity_PropertyOrMethodNotFound', 
    ...
    {
        return 'projects/' . $this->project->name . '/Scope/WBS/' . 
        str_replace(theMetrics::SEPARATOR, '-', $this->code);
    }
    ...
    protected function _getDuration()
    {
        ...
        return intval(ceil(($this->cost->usd / self::DEFAULT_PRICE_PER_HOUR_USD) / 4));
    }
